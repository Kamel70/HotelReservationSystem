...
namespace HotelReservationSystem.DataAccess.Migrations
{
    ...
    [Migration("20250628000824_make relation between room and user")]
    partial class makerelationbetweenroomanduser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelReservation.DataAccess.Models.Hotel", b =>
                {
                    b.HasOne("HotelReservation.DataAccess.Models.ApplicationUser", null)
                        .WithOne("hotel")
                        .HasForeignKey("HotelReservation.DataAccess.Models.Hotel", "managerId")
